    ...
    <main className={`text-center w-100 balance ${styles.main}`}>
      ...
      <section id='section1' className={`${styles.section1} d-flex`}>
        <div className='d-flex flex-md-row flex-column w-100'>
          <div className='d-flex flex-column col-13 col-md-9'>
            <Image
              src={index1}
              alt='Hotel pool view'
              // layout='responsive'
          ...
          <div className='d-flex flex-column col-13 col-md-3 justify-content-center'>
            <h1 className={`fs-3 mb-2 px-5 ${styles.description}`}>Brows and reserve rooms</h1>
            <a href='/prices' className={styles.arrowDown}>
              <ArrowDownCircle />
            </a>
          </div>
        </div>
